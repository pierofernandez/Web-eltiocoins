export const InformationObjetivos = () => {
    return (
        <div className="relative py-10 sm:py-16 md:py-24">
            <div className="relative z-10">
                {/* Header Section */}
                <div className="text-center mb-10 sm:mb-16 px-4">
                    <h1 className="text-3xl sm:text-5xl md:text-6xl font-black mb-4 sm:mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-lg">
                        ¿Qué son los Objetivos de EA FC 26?
                    </h1>
                    <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-cyan-400 to-purple-600 mx-auto rounded-full"></div>
                </div>
                ...
                <div className="max-w-6xl mx-auto px-4 space-y-8 sm:space-y-12">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-5 sm:p-8 shadow-2xl">
                            <div className="flex items-center mb-4 sm:mb-6">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                                    <span className="text-xl sm:text-2xl">🎯</span>
                                </div>
                                <h2 className="text-lg sm:text-2xl font-bold text-white">Desafíos y Recompensas</h2>
                            </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        {[
                            ...
                            <div key={index} className="group">
                                <div className={`relative bg-gradient-to-br ${benefit.bgColor} backdrop-blur-sm border ${benefit.borderColor} rounded-2xl p-5 sm:p-6 shadow-2xl ${benefit.shadowColor} transition-all duration-300 hover:scale-105 h-full`}>
                                    <div className="flex items-center mb-3 sm:mb-4">
                                        <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${benefit.color} rounded-xl flex items-center justify-center mr-3 flex-shrink-0`}>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-5 sm:p-8 shadow-2xl">
                            <div className="flex items-center justify-center mb-6 sm:mb-8">
                                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-cyan-500 to-indigo-600 rounded-2xl flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                                    <span className="text-2xl sm:text-3xl">🛡️</span>
                                </div>
                                <h2 className="text-xl sm:text-3xl font-bold text-white break-all">eltiocoins.com</h2>
                            </div>
                            ...
                            <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gradient-to-r from-cyan-600/20 to-indigo-600/20 rounded-xl border border-cyan-500/30">
                                <p className="text-center text-gray-300 text-sm sm:text-lg leading-relaxed">
