        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mt-8 relative">
                    {/* Botón de Twitch solo para tablet */}
                    ...
                    {/* Card: oculta en móvil, desplegable en tablet, fija en desktop */}
                    <div className={`hidden sm:block fixed right-4 z-10 transition-transform duration-500 ease-in-out
                    ...
                    >
                        <div className="bg-black/40 backdrop-blur-sm rounded-xl p-4 border border-purple-500/20 flex items-center gap-4 transform hover:scale-105 transition-transform duration-300">
                            {/* Contenedor de imagen con sombra y brillo */}
